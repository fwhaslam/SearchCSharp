...
REM       DeployNugetPackageLocally.bat $(Version) $(ProjectKey)
REM
...
REM DEVELOPER SPECIFIC VALUE / local values
set REPO=C:\Users\Fred\NugetRepository
REM set REPO="C:\Program Files (x86)\Microsoft SDKs\NuGetPackages\"
